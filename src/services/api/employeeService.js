    ...
    try {
      ...
      if (searchParams.searchTerm) {
        whereConditions.push({
          fieldName: "full_name",
          operator: "Contains",
          values: [searchParams.searchTerm]
        });
      }
      ...
      if (searchParams.department) {
        whereConditions.push({
          fieldName: "department",
          operator: "ExactMatch",
          values: [searchParams.department]
        });
      }
      ...
      if (searchParams.designation) {
        whereConditions.push({
          ...
          operator: "ExactMatch",
          values: [searchParams.designation]
        });
      }
      ...
      if (searchParams.employeeId) {
        whereConditions.push({
          ...
          operator: "Contains",
          values: [searchParams.employeeId]
        });
      }
      ...
      if (searchParams.sortBy && searchParams.sortDirection) {
        params.orderBy = [{
          fieldName: searchParams.sortBy,
          SortType: searchParams.sortDirection.toUpperCase()
        }];
      }
